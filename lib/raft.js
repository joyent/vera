...
Raft.prototype.sendAppendEntries = function (index, cb) {
    ...
    function onResponse(err, from, res) {
        ...
        //TODO: Also, what to do about blackholing requests.  If we have a
        // majority down, this is never going to end.
        ...
        //TODO: We need to split this out into successes/failures and return
        // when there is either a majority success or a majority failure.
        // The goal is to return as soon as possible, either way.
