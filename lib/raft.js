...
function _executeEntries(index, cb) {
    ...
    self.clog.slice(smIndex + 1, index + 1, function (err, entries) {
        ...
        //We send a filtered stream to the state machine.
        //TODO: If we actually send this through the transform stream, then
        // something doesn't go right with the memraft cluster tests.
