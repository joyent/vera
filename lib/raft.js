...
function Raft(opts) {
    ...
    self.requestVotes = getRequestVotesPipe.call(self);
...
function _requestVote(req, cb) {
    ...
    if (req.term < currentTerm) {
        ...
        return (end(new error.InvalidTermError('outdated term')));
    }
...
Raft.prototype.requestVote = function (req, cb) {
    ...
    var self = this;
    self.requestVotes.append(req, cb);
};
